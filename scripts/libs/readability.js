...
var tagsToSkip = {__proto__:null,aside:true,footer:true,head:true,label:true,nav:true,noscript:true,script:true,select:true,style:true,textarea:true},
    ...
    embeds = {__proto__:null,embed:true,object:true,iframe:true,audio:true,video:true}, //iframe/audio/video added for html5 players
    ...
    okayIfEmpty = ['audio','video','source','embed','iframe','img','object','svg','path'],
...
Readability.prototype.onattribute = function(name, value){
	...
	if(name === 'href' || name === 'src'){
		...
		else if(name === 'width' ? value >= 400 : value >= 300){
	...
	else if(elem.name === 'img' && name === 'alt'){
		elem.parent.attributeScore += 10;
	}
